...
use HQGames\addons\simplepackethandler\utils\Utils;
...
/**
 * Class PacketInterceptorListener
 ...
 * @project Core
 */
class PacketInterceptorListener implements IPacketInterceptor, Listener{
	/**
	...
	public function __construct(private PluginBase $register, private int $priority, private bool $handleCancelled){
	}
